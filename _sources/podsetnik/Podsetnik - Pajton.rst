...
У овој лекцији вам дајемо кратак подсетник на основне елементе и
...
.. technicalnote::
    ...
    Примере из ове лекције можеш пвовежбати у оквиру радне свеске `02_podsetnik.ipynb <https://petlja.github.io/gim2_rac_prog_radni/lab?path=02_podsetnik.ipynb>`_. Ако кликнеш на претходни линк свеску ћеш отворити у Џупитерлајт окружењу, а најбоље би било да користиш Џупитер окружење на свом рачунару како је описано у одељку Покретање Џупитер радних свески.
