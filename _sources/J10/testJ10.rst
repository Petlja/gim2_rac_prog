...
.. mchoice:: Тест14_Питање1
   ...
   Којом наредбом ћемо учитати само табела која се налази на другом радном листу?
...
.. mchoice:: Тест14_Питање2
   ...
   :answer_d: Систем пријављује грешку зато што функције read_csv не познаје опцију header=None.
   :correct: c
   :feedback_a: Покушај поново!
   :feedback_b: Покушај поново!
   :feedback_c: Тачно!
