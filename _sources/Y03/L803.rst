...
.. activecode:: primer3-1
   :includesrc: _src/P3_Vokativ.py

.. infonote::

   Изврши исти програм и у Пајтон окружењу!
   
   Покрени IDLE, из фолдера ``primeri`` учитај програм ``P3_Vokativ.py`` и изврши га.
...
.. activecode:: primer3-3
   :includesrc: _src/P3_Broj_simbola.py
...
.. infonote::
   ...
   Покрени IDLE, из фолдера ``primeri`` учитај програм ``P3_Broj_simbola.py`` и изврши га.
...
.. activecode:: primer3-4
   :includesrc: _src/P3_Zagrade.py

.. infonote::

   Изврши исти програм и у Пајтон окружењу!
   
   Покрени IDLE, из фолдера ``primeri`` учитај програм ``P3_Zagrade.py`` и изврши га.
...
.. activecode:: primer3-12
   :includesrc: _src/P3_Prebroj_podstr.py

.. infonote::

   Изврши исти програм и у Пајтон окружењу!
   
   Покрени IDLE, из фолдера ``primeri`` учитај програм ``P3_Prebroj_podstr.py`` и изврши га.
...
.. activecode:: primer3-13
   :includesrc: _src/P3_Ekstenzije.py

.. infonote::

   Изврши исти програм и у Пајтон окружењу!
   
   Покрени IDLE, из фолдера ``primeri`` учитај програм ``P3_Ekstenzije.py`` и изврши га.
...
.. activecode:: primer3-14
   :includesrc: _src/P3_Broj_reci.py

.. infonote::

   Изврши исти програм и у Пајтон окружењу!
   
   Покрени IDLE, из фолдера ``primeri`` учитај програм ``P3_Broj_reci.py`` и изврши га.
...
.. activecode:: primer3-19
   :includesrc: _src/P3_Obrni_string.py

.. infonote::

   Изврши исти програм и у Пајтон окружењу!
   
   Покрени IDLE, из фолдера ``primeri`` учитај програм ``P3_Obrni_string.py`` и изврши га.
...
.. activecode:: primer3-20
   :includesrc: _src/P3_Palindrom.py

.. infonote::

   Изврши исти програм и у Пајтон окружењу!
   
   Покрени IDLE, из фолдера ``primeri`` учитај програм ``P3_Palindrom.py`` и изврши га.
