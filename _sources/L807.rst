...
Са `овог линка <iliad.txt>`_ можеш да преузмеш текстуалну датотеку
...
на `овом линку <Top25YouTubers.csv>` се налази датотека *Top25YouTubers.csv* која изгледа овако:
...
Са `овог линка <iliad.txt>`_ преузми текстуалну датотеку
...
Зип фајл који садржи ове датотеке можеш да преузмеш `овде <BOOK1-12.zip>`_.
...
**Задатак 4.** у тексуталној датотеци `brojevi.txt <brojevi.txt>`_ налази се више редова текста,
