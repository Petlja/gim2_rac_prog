...
.. quizq::
   ...
   .. mchoice:: Тест1_4_Питање4
      ...
      :answer_b: print(sum(Dejanove_ocene))
      :answer_c: print(len(Dejanove_ocene))
      :answer_d: print(sum(Dejanove_ocene)/len(Dejanove_ocene))
      :correct: d
      :feedback_a: Пробај поново! (Немамо на располагању променљиву Dejanov_prosek)
      :feedback_b: Пробај поново! (Функција sum рачуна збир низа бројева, а нама треба просек)
      :feedback_c: Пробај поново! (Функција len рачуна дужину низа, а нама треба просек)
      :feedback_d: Тачно!
...
.. quizq::
   ...
   .. mchoice:: Тест1_4_Питање5
      ...
      Шта ће бити резултат следећег блока инструкција?
